...
export const Route = createFileRoute('/integration/drizzle')({
			...
			>
				...
				<form onSubmit={handleSubmit} className="flex gap-2">
					<input
						...
						className="flex-1 px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 transition-all text-white placeholder-indigo-300/50 focus:ring-[rgba(93,103,227,0.5)]"
						style={{
